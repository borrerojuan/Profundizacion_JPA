...
import com.Profundizacion_JPA.Controllers.ArticulosJpaController;
import com.Profundizacion_JPA.Controllers.ClientesJpaController;
import com.Profundizacion_JPA.Controllers.FacturaarticuloJpaController;
...
import static com.Profundizacion_JPA.Entities.Clientes_.correo;
import com.Profundizacion_JPA.Entities.Facturaarticulo;
...
public class SelecciónArticulos extends javax.swing.JFrame {
    ...
    void hacer_compra() {
        ...
        if (tarjeta.equals("") || cvv.equals("") || fechaVencimiento.equals("") || cuotas.equals("")) {

            JOptionPane.showMessageDialog(null, "Debe llenar todos los campos de pago");

        } else if (identificaion.equals("") || telefono.equals("") || ciudad.equals("") || direccion.equals("")) {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("PAGA TUS PRODUCTOS Y TE LO ENVIAMOS");

        jLabel7.setFont(new java.awt.Font("Raleway Medium", 1, 15)); // NOI18N
        jLabel7.setText("DATOS DE PAGO");

        jLabel8.setFont(new java.awt.Font("Raleway Medium", 1, 15)); // NOI18N
        jLabel8.setText("DATOS DE ENVÍO");

        jLabel9.setFont(new java.awt.Font("Raleway Medium", 0, 15)); // NOI18N
        jLabel9.setText("N°. TARJETA:");

        jLabel11.setFont(new java.awt.Font("Raleway Medium", 0, 15)); // NOI18N
        jLabel11.setText("CVV:                                    ");

        jLabel12.setFont(new java.awt.Font("Raleway Medium", 0, 15)); // NOI18N
        jLabel12.setText("FECHA DE VENCIMIENTO:");

        jLabel13.setFont(new java.awt.Font("Raleway Medium", 0, 15)); // NOI18N
        jLabel13.setText("NO. CUOTAS:");
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(txtCuotas, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtFechaVencimiento, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
